...
class MyTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.recall_score = recall_score(self.y_val, self.y_pred, average='macro')
    ...
    def test_recall_score(self):
        self.assertEqual(self.exercises.recall_score, self.recall_score)
