...
class Test(unittest.TestCase):
    def setUp(self):
        import Exercise_16_05_Spot_checking_multiple_models_using_Pipeline_v1_0
        self.exercises = Exercise_16_05_Spot_checking_multiple_models_using_Pipeline_v1_0		
