...
class Test(unittest.TestCase):
	def setUp(self):
		...
		self.logLinearModel = smf.ols(formula='np.log(crimeRatePerCapita) ~ medianValue_Ks', data=self.train_data)
		self.logLinearModResult = self.logLinearModel.fit()
	...
	def test_params(self):
		np_testing.assert_array_equal(self.exercises.logLinearModResult.params, self.logLinearModResult.params)
