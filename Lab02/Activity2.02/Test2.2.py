...
class Test(unittest.TestCase):
	...
	def test_params(self):
		np_testing.assert_array_equal(self.exercises.multiLogLinModResult.params, self.multiLogLinModResult.params)
