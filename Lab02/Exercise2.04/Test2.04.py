...
class Test(unittest.TestCase):
	def setUp(self):
		...
		self.linearModel = smf.ols(formula='crimeRatePerCapita ~ medianValue_Ks', \
							  data=self.train_data)
		self.linearModelResult = self.linearModel.fit()
	...
	def test_params(self):
		np_testing.assert_array_equal(self.exercises.linearModelResult.params, self.linearModelResult.params)
